  ...
  <div class="container-fluid">
	...
	<center>
		...
		<form:form id="registerForm"  method="post"
			action="./updateProduct" commandName="supp">
			<table width="400px" height="150px">
			<tr>
					<td><label>supplier id</label></td>
					<td><form:input path="sid" value="${prdList.sid}" readonly="true" /></td>
				</tr>
				<tr>
					<td><label>supplier name</label></td>
					<td><form:input path="sname" value="${prdList.sname}" /></td>
				</tr>
				<tr>
					<td><label>supplier place</label></td>
					<td><form:input path="description" value="${prdList.place}"/></td>
				</tr>
